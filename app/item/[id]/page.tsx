  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col gap-6">
        {/* ── Image ── */}
        {item.image_url && (
          <div className="relative w-full overflow-hidden rounded-3xl border border-gray-200/80 bg-gray-900/5 shadow-xs aspect-[16/9] max-h-96">
            <Image
              src={item.image_url}
              alt={item.title}
              fill
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
          ...
          <section className="sm:col-span-2 rounded-2xl border border-gray-200/80 bg-white p-6 shadow-xs">
            <h2 className="mb-3 text-xs font-bold uppercase tracking-wider text-gray-400 flex items-center gap-1.5">
          ...
          <section className="rounded-2xl border border-gray-200/80 bg-white p-6 shadow-xs">
            <h2 className="mb-4 text-xs font-bold uppercase tracking-wider text-gray-400 flex items-center gap-1.5">
            ...
            <dl className="flex flex-col gap-3 text-sm">
              <div>
                <dt className="text-xs text-gray-400 font-medium">Campus Area</dt>
                <dd className="mt-0.5 font-semibold text-gray-900">{item.campus_area}</dd>
              </div>
              <div>
                <dt className="text-xs text-gray-400 font-medium">Specific Location</dt>
                <dd className="mt-0.5 font-semibold text-gray-900">{item.specific_location}</dd>
              </div>
            </dl>
          </section>
          ...
          <section className="rounded-2xl border border-gray-200/80 bg-white p-6 shadow-xs">
            ...
            <dl className="flex flex-col gap-3 text-sm">
              <div>
                ...
                <dd className="mt-0.5 font-semibold text-gray-900">{item.category}</dd>
              </div>
              <div>
                <dt className="text-xs text-gray-400 font-medium">Date Lost / Found</dt>
                <dd className="mt-0.5 font-semibold text-gray-900">{formattedDate}</dd>
              </div>
              <div>
                <dt className="text-xs text-gray-400 font-medium">Reported On</dt>
                <dd className="mt-0.5 font-semibold text-gray-900">{formattedReported}</dd>
              </div>
            </dl>
          </section>

          {/* Contact Card */}
          <section className="sm:col-span-2 rounded-2xl border border-blue-100 bg-gradient-to-r from-blue-50/60 to-white p-6 shadow-xs">
            <h2 className="mb-4 text-xs font-bold uppercase tracking-wider text-blue-700 flex items-center gap-1.5">
            ...
            <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2 text-sm">
              <div>
                <dt className="text-xs text-gray-400 font-medium">Contact Name</dt>
                <dd className="mt-0.5 font-semibold text-gray-900">{item.contact_name}</dd>
              </div>
              <div>
                <dt className="text-xs text-gray-400 font-medium">Phone Number</dt>
                <dd className="mt-0.5">
                  <a
